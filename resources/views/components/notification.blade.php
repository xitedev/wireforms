<div
    ...
    class="fixed inset-0 z-50 flex flex-col items-start justify-start px-4 py-6 space-y-4 pointer-events-none sm:p-6 sm:justify-end"
>
                ...
                <div class="p-4">
                    <div class="flex items-start">
                        ...
                        <div class="ml-3 w-0 flex-1 pt-0.5 space-y-1">
                            <p x-text="message.message" class="text-sm text-gray-500"></p>
                        </div>
